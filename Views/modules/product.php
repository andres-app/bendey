                                ...
                                <form action="" name="formulario" id="formulario" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <div class="mt-2">
                                                <img src="" alt="" id="imagenmuestra" style="max-width: 150px; max-height: 120px;">
                                            </div>
                                        </div>
                                        ...
                                        <div id="atributos_section" class="col-12" style="display:none;">
                                            <div class="row">
                                                <div class="form-group col-lg-6">
                                                    ...
                                                    <select class="form-control" id="color" multiple></select>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <label for="talla">Talla:</label>
                                                    <select class="form-control" id="talla" multiple></select>
                                                </div>
                                            </div>
                                            <button type="button" class="btn btn-info btn-sm" onclick="generarVariaciones()">Generar combinaciones</button>
                                            <div id="variaciones-container" class="col-12 mt-3" style="display:none;">
                                                <h5 class="mt-3">Variaciones del producto</h5>
                                                <div class="row" id="variaciones-lista"></div>
                                            </div>
                                        </div>
