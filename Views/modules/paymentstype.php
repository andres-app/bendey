                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Tipos de pago <button class="btn btn-success" onclick="mostrarform(true)"
                                ...
                                <form action="" name="formulario" id="formulario" method="POST">
                                    <div class="row">
                                        <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                            ...
                                            <input class="form-control" type="hidden" name="idtipopago" id="idtipopago">
...
require "footer.php";
?>
<script src="Views/modules/scripts/paymentstype.js"></script>
<?php
 }
  ob_end_flush();
  ?>