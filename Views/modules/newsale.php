                            ...
                            <div id="formularioregistros">
                                <form action="" name="formulario" id="formulario" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-8 col-md-8 col-xs-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <button class="btn btn-success" type="button" onclick="agregarCliente()">
                                        ...
                                        <div id="pago_mixto" class="col-lg-12 mt-3" style="display: none;">
                                            <div class="row">
                                        ...
                                        <div id="pago_credito" class="col-lg-12 mt-3" style="display: none;">
                                        ...
                                        <!-- Tabla de detalles -->
                                        <div class="form-group col-lg-12 col-md-12 col-xs-12 mt-3">
...
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('agregar_cuota').addEventListener('click', function() {
        ...
        // Añadir el nuevo div al contenedor de cuotas
