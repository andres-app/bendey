...
?>
    <table border="1" id="tbllistado" class="table table-striped table-hover text-nowrap text-center"
      ...
      <thead>
        <tr>
          <th colspan="2">Existencia actual: <?php  //echo $sotck;
                                              ?></th>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td style="background:#ECF6CE;"><?php echo $reg['cantidadex']; //($reg['cantidadex']>0)?$reg['cantidadex']:'';
                                            ?></td>
            <td style="background:#ECF6CE;"><?php echo $reg['costouex']; //($reg['costouex']>0)?$reg['costouex']:'';
                                            ?></td>
            <td style="background:#ECF6CE;"><?php echo $reg['totalex']; //($reg['totalex']>0)?number_format($reg['totalex'],2,'.',','):'';
                                            ?></td>
          </tr>
        <?php
        }
