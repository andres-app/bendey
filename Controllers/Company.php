...
$token_reniec_sunat = isset($_POST["tokendniruc"]) ? $_POST["tokendniruc"] : ""; // Agregado para manejar el token
...
switch ($_GET["op"]) {
    case 'guardaryeditar':
        ...
        // Modificar el método editar para incluir el token
        $rspta = $company->editar($id_negocio, $nombre, $ndocumento, $documento, $direccion, $telefono, $email, $logo, $pais, $ciudad, $nombre_impuesto, $monto_impuesto, $moneda, $simbolo, $token_reniec_sunat);
